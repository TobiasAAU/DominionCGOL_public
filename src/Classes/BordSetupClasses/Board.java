...
public class Board {
    ...
    public Board(ArrayList<Player> players, Supply startingSupply) {
        ...
        this.trashPile = new CardStack(new ArrayList<DomCard>());
    ...
    public void nextPlayer() {
        ...
        System.out.println("New turn for Player" + actiPlayer.getName());
    }
    ...
    public void printBoard() {
        printSupply();
        System.out.println("Trash Pile: " + this.trashPile.size() + " cards");
    }

    public void printSupply() {
        System.out.println("The Supply:");
